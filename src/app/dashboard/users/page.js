...
export default function UsersPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Helper: upload avatar file if one was selected
      const uploadAvatarIfNeeded = async (employeeId) => {
      ...
      // Build JSON payload (no avatar — uploaded separately)
      const basePayload = {
      ...
      if (editMode) {
        ...
        if (res.ok) {
          await uploadAvatarIfNeeded(editingUserId);
          await fetchUsers();
          closeModal();
