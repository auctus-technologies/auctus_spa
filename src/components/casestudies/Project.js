...
const ProjectsArea = () => {
    return (
        <>
            ...
            <div className="rts-project-area rts-section-gap2Bottom">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="project-style-5-title-between">
                                ...
                                <p className="disc">
                                    Explore our portfolio of innovative web solutions built with modern technologies.
                                    ...
                                    >
                                        <SwiperSlide>
                                            <div className="single-project-area-5">
                                                <a href="#" className="thumbnail">
                                                    <img
                                                        src="assets/images/projects/01.png"
                                                        alt="case-studies"
                                                    />
                                                </a>
                                        ...
                                        <SwiperSlide>
                                            <div className="single-project-area-5">
                                                <a href="#" className="thumbnail">
                                                    <img
                                                        src="assets/images/projects/02.png"
                                                        alt="case-studies"
                                                    />
                                                </a>
                                                <div className="inner-content">
                                                    <div className="inner">
                                                        <div className="left-content">
                                                            ...
                                                            <a href="#">
                                                                <h4 className="title">Attendance System</h4>
                                                            </a>
                                                        </div>
                                                        <div className="icon-area">
                                                            <a href="#">
                                        ...
                                        <SwiperSlide>
                                            <div className="single-project-area-5">
                                                <a href="#" className="thumbnail">
                                                    <img
                                                        src="assets/images/projects/03.png"
                                                        alt="case-studies"
                                                    />
                                                </a>
                                                <div className="inner-content">
                                                    <div className="inner">
                                                        <div className="left-content">
                                                            <span>Django, Python, Tailwind CSS</span>
                                                            <a href="#">
